...
<div class="flex min-h-screen">
    <section class="bg-gray-50 dark:bg-gray-900 flex-1">
        <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
            <img class="w-35 h-28 mr-2" src="/img/logo.png" alt="logo">
     ...
     <div class="bg-[url(img/agriculture-industry.jpg)] flex-1 bg-cover bg-center">
        <h2 class="text-white text-3xl font-bold absolute right-8">Test System</h2>
        <p class="text-white absolute right-8">Description</p>
    </div>
</div>
